...
Route::get('/newOrder/{chef}', [PublicPizzaController::class, 'add'])->name('public.pizzas.add');
Route::post('/newOrder', [PublicPizzaController::class, 'store'])->name('public.pizzas.store');
